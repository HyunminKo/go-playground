...
func (c *userClient) ListUser(ctx context.Context, in *ListUsersRequest, opts ...grpc.CallOption) (*ListUsersResponse, error) {
...
func (UnimplementedUserServer) ListUser(context.Context, *ListUsersRequest) (*ListUsersResponse, error) {
...
func _User_ListUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).ListUser(ctx, req.(*ListUsersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
